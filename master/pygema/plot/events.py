...
def plot_cumulative_seismicity(starttime, endtime, dark_background=True, show_plot=False, save_plot=True, savedir=None, format='jpg', dpi=150):
  ...
  # plot seismicity
  events_list = select_events_manual_loc( starttime, endtime, table="LOC", max_gap=360, max_depth=250)
  ...
  markerline, stemlines, baseline = ax1.stem(utcs, nevents, markerfmt='None', basefmt='None', linefmt='C0-')
  plt.setp(stemlines, 'linewidth', 1.5)


  evmags = np.array(events_list).T[8]
